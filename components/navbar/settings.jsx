...
var ServiceKey = require('../service_key/index');
  ...
  onClick(key, e) {
    switch (key) {
      case 'settings':
        ...
        div.setAttribute('class', 'settings-detail');
        ...
        ReactDOM.render(<ServiceKey __={this.props.__}/>, document.getElementsByClassName('settings-detail')[0]);
        break;
      case 'en':
